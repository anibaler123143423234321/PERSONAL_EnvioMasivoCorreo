...
class Email extends PHPMailer{
    ...
    protected $gCorreo="dagner_smooth@outlook.com";//Correo Electronico 
    protected $gContrasena="esterno1";//Contraseña del la cuenta de correo
    ...
    public function enviar_correo(){
        ...
        foreach ($datos2 as $row2) {
          ...
          $cuerpo = str_replace('$xemaildesuscribirse', 'http://localhost/PERSONAL_EnvioMasivoCorreo_Admin/view/desuscribirse/?email='.$row2["usu_correo"], $cuerpo);
          $this->Body = $cuerpo;
